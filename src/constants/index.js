...
export const myProjects = [
  ...
  // },
  {
    ...
    href: 'https://abn-look-up-poc.vercel.app/',
    texture: '/textures/project/ABN_LookUP_POC.mp4',
    logo: '/assets/ABN_Lookup_POC.png',
    logoStyle: {
  ...
  {
    title: 'CryptoTracker - Real-time Cryptocurrency Tracking & Conversion',
    desc: 'A modern, responsive web application providing up-to-date cryptocurrency market data and a convenient conversion tool. It features a secure full-stack architecture with a React frontend and a Node.js Express backend.',
    subdesc: [
      'Provides real-time cryptocurrency listings with efficient frontend pagination.',
      'Enables intuitive crypto-to-crypto and crypto-to-fiat (USD) currency conversion.',
      'Implemented secure API key handling via a Node.js backend proxy hosted on Render.',
      'Optimized for performance with lazy loading, component memoization, and client-side data pagination.'
    ],
    href: 'https://crypto-tracker-six-pink.vercel.app/',

    // Textures/Logos - Replace with your actual paths
    texture: '/textures/project/CryptoTracker.mp4',
    logo: '/assets/CryptoTracker.png',
    logoStyle: {
      
backgroundColor: 'rgba(96, 245, 161, 0.04)', // Your #60F5A1 with a very low 5% opacity
background:
  'linear-gradient(0deg, rgba(96, 245, 161, 0.02), rgba(96, 245, 161, 0.02)), ' + // Original green at 2% opacity
  'linear-gradient(180deg, rgba(255, 255, 255, 0.1) 0%, rgba(208, 213, 221, 0.08) 100%)', // White and light grey now very faint
border: '0.2px solid rgba(208, 213, 221, 0.2)', // Border almost transparent at 20% opacity
boxShadow: '0px 0px 60px 0px rgba(35, 131, 96, 0.03)', // Shadow barely there at 3% opacity
    },
    spotlight: '/assets/spotlight3.png',
    tags: [
      { "id": 1, "name": 'React.js', "path": '/assets/react.svg' },
      { "id": 2, "name": 'Vite', "path": '/assets/Vite.js.svg' },
      ...
      { "id": 6, "name": 'Express.js', "path": '/assets/expressjs-icon.svg' },
      { "id": 7, 'name': 'Axios', "path": '/assets/axios-icon.svg' },
      { "id": 8, "name": 'CoinMarketCap API', "path": '/assets/cmcapi.png' },
      { "id": 9, 'name': 'Vercel', "path": '/assets/vercel.svg' },
      { id: 10, 'name': 'Render', "path": '/assets/render.svg' },
    ]
  },
  {
