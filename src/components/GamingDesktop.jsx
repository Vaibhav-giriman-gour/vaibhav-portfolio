...
export function GamingDesktop(props) {
  ...
  const wallpaper = useTexture('/textures/desk/wallpaper.png')
  // const deskMaterial = useTexture('/textures/desk/Material.063_baseColor.jpeg')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        <meshMatcapMaterial map={wallpaper}/>
        </mesh>
      <mesh
        castShadow
        receiveShadow
